...
public class TictacControl {
    ...
    public boolean verificarGanador() {
        for (int i = 0; i < 3; i++) {//es para comprobar si las filas columas y diagonles son iguale
            if (tablero[i][0].getText().equals(tablero[i][1].getText()) && tablero[i][0].getText().equals(tablero[i][2].getText()) && !tablero[i][0].getText().isEmpty()) {
                return true;
            }
            if (tablero[0][i].getText().equals(tablero[1][i].getText()) && tablero[0][i].getText().equals(tablero[2][i].getText()) && !tablero[0][i].getText().isEmpty()) {
                return true;
            }
        }
        if (tablero[0][0].getText().equals(tablero[1][1].getText()) && tablero[0][0].getText().equals(tablero[2][2].getText()) && !tablero[0][0].getText().isEmpty()) {
            return true;
        }
        if (tablero[0][2].getText().equals(tablero[1][1].getText()) && tablero[0][2].getText().equals(tablero[2][0].getText()) && !tablero[0][2].getText().isEmpty()) {
            return true;
        }
        return false;
    }
